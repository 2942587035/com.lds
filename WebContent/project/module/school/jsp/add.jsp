<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<script src="<%=request.getContextPath()%>/project/module/school/js/add.js"></script>
	...
	<form id="addForm">
		<table id="addTable">
			...
			<tr>
				...
				<td class="text">
				<input type="text" class="disableInputMethod" id="xx_code" name="xx_code" 
				maxlength="6" required="true" readonly="readonly"
				...
				<td>
				<select id="xx_type" name="xx_type" class="text" onkeypress="parent.transferFocus(event,this)">
			...
			<tr>
				...
				<td class="text" colspan="5">
				<input type="text" id="xx_remark" name="xx_remark" maxlength="255" onkeypress="parent.transferFocus(event,this)"/>
				</td>
			</tr>
			<tr>
