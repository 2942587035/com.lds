<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<script src="<%=request.getContextPath()%>/project/module/school/js/edit.js"></script>
	...
	<form>
		<table>
			...
			<tr>
				...
				<td class="text"><input type="text" class="disableInputMethod" name="xx_code" 
				...
				<td>
				    <select name="xx_type" class="text" onkeypress="parent.transferFocus(event,this)">
