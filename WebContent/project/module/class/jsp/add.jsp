<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<script src="<%=request.getContextPath()%>/project/module/class/js/add.js"></script>
	...
	<form id="addForm">
		<table id="addTable">
			...
			<tr>
				...
				<td class="text">
				    <input type="text" class="disableInputMethod" readonly="readonly" id="bj_code" name="bj_code" maxlength="8" required="true" 
				    onkeypress="parent.transferFocus(event,this)"/>
				</td>
				<td class="label">名称：</td>
				<td class="text">
				    <input type="text" id="bj_name" name="bj_name" maxlength="10" required="true" 
				    onkeypress="parent.transferFocus(event,this)"/>
				</td>
